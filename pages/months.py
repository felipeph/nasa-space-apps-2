...
months_list = ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10"]

month = st.selectbox(label="Select a month of 2023", options=months_list)
...
@st.cache_data
def load_month_csv(month):
    month_csv_path = f"data/months/focos_mensal_br_2023{month}.csv"
    df = pd.read_csv(month_csv_path)
    return df

df = load_month_csv(month)
